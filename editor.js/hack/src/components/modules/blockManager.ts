...
export default class BlockManager extends Module {
  ...
  public composeBlock({ tool, id = _.generatePlainUUId(), data = {} }: {tool: string; id?: string; data?: BlockToolData}): Block {
   ...
   * @param {string} options.id - plugin's unique id
