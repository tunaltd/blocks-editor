...
/**
 * Ref: http://stackoverflow.com/a/8809472
 * 
 * @returns {string} like 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'
 */
...
/**
 * calls generateUUId() but removes '-'
 * 
 * @returns {string} like 'xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx'
 */
export function generatePlainUUId(): string {
