 ...
 * @property {object} info - Unsplash image information
 *  - author: Unsplash image author name
 *  - profileLink: Author profile link
 */
export default class OneImage {
  /**
   ...
   *
   * @param {OneImageData} data Image data
   */
  set data(data) {
